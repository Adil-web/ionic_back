...
<arg name=\"phone\">${phone}</arg>
        ...
        await axios.post('http://192.168.21.239/api/', xmlCreateObject, config).then((response) => {
...
<arg name=\"object\">${dataXml}</arg>
        ...
        axios.post('http://192.168.21.239/api/', getXmlObject, config).then((response) => {
...
//192.168.21.239
//31.169.9.82
        await axios.post('http://192.168.21.239/api/', getXmlObject, config).then((response) => {
            let getXml = parser.parse(response.data)
            // console.log(response.data)
            // console.log(getXml.sbapi.body.response.objects)
            // console.log(getXml.sbapi.body.response.objects.forEach(e=> e.object.number))
